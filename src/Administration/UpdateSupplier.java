 ...
 private JButton button;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateSupplier frame = new UpdateSupplier(trackid,roleid, empID, userName);
	 ...
	 * @param empID2 
	 */
	public UpdateSupplier(final int trackID,int roleid, final int empID,  String userName) {
...
if (size == 0) {
		...
		lblNewLabel = new JLabel("Update/View  Supplier");
		...
		btnSave.setToolTipText("Save added Supplier info");
		...
		btnSave.setBounds(798, 218, 89, 23);
