...
public class WHouseShortage extends JFrame {
	...
	public static final int classID = 28;
	static int roleid;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WHouseShortage frame = new WHouseShortage(trackID,roleid, empID, userName);
	 ...
	 * @param empID2 
	 */
	public WHouseShortage(final int trackID,int roleid, final int empID, String userName) {
		setTitle("View Warehouse  Shortage");
		...
		String[] columns = new String[] { "No", "ProID", "Description",
				"lwuQty Left","hwuQty Left", "Limit Level", "Location" };
		...
		btnPopulateTable
				.setToolTipText("Click to display all Warehouse items that have gone below limit.");
		btnPopulateTable.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				WHouseInventory ri = new WHouseInventory();

				// int noRetItems = ri.getRetInvCount();

				WarehouseShortage = ri.getWarehouseShortage();
				int noRetItems = WarehouseShortage.length;
				for (int r = 0; r < noRetItems; r++) {

					myModel.insertRow(r, new Object[] { r + 1,
							WarehouseShortage[r][0], WarehouseShortage[r][1],
							WarehouseShortage[r][2], WarehouseShortage[r][3],
							WarehouseShortage[r][4], WarehouseShortage[r][5],
					 });
		...
		JLabel lblInventoryTable = new JLabel("VIEW ALL Warehouse SHORTAGE");
